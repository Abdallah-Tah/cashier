<div class="max-w-[1920px] mx-auto">
    <div class="bg-gradient-to-r from-cyan-900 to-cyan-700 text-gray-100 text-[15px]">
        <header class='py-4 px-4 sm:px-10 z-50 min-h-[70px]'>
          <div class='relative flex flex-wrap items-center gap-4'>
            ...
            <div id="collapseMenu" class='max-lg:hidden lg:!block max-lg:fixed max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50 z-50'>
              ...
              <ul class='lg:ml-12 lg:flex gap-x-6 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                ...
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='javascript:void(0)' class='hover:text-cyan-300 text-white block font-semibold transition-all'>Home</a>
                </li>
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='javascript:void(0)' class='hover:text-cyan-300 text-white block font-semibold transition-all'>Team</a>
                </li>
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='javascript:void(0)' class='hover:text-cyan-300 text-white block font-semibold transition-all'>Features</a>
                </li>
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='javascript:void(0)' class='hover:text-cyan-300 text-white block font-semibold transition-all'>Blog</a>
                </li>
                <li class='max-lg:border-b max-lg:py-3 px-3'>
                  <a href='javascript:void(0)' class='hover:text-cyan-300 text-white block font-semibold transition-all'>About</a>
                </li>
              </ul>
            </div>

            <div class='flex ml-auto'>
              <button class='px-6 py-3 rounded-xl text-white bg-cyan-600 hover:bg-cyan-700 transition-all shadow-lg'>Login</button>
        ...
        <div class="relative">
          <div class="px-4 sm:px-10">
            <div class="mt-16 max-w-4xl mx-auto text-center relative z-10">
              <h1 class="md:text-6xl text-4xl font-extrabold mb-6 md:!leading-[75px] bg-clip-text text-transparent bg-gradient-to-r from-white to-cyan-200">Build Landing Pages with Typeform Integration</h1>
              <p class="text-lg text-cyan-100">Embark on a gastronomic journey with our curated dishes, delivered promptly to your doorstep. Elevate your dining experience today.</p>
              <div class="mt-10">
                <button class='px-8 py-4 rounded-xl text-white bg-gradient-to-r from-cyan-500 to-cyan-700 hover:from-cyan-600 hover:to-cyan-800 transition-all shadow-xl'>Get started today</button>
              </div>
            </div>
            <hr class="my-12 border-cyan-600/30" />
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-80">
              <img src="https://readymadeui.com/google-logo.svg" class="w-28 mx-auto brightness-0 invert" alt="google-logo" />
              <img src="https://readymadeui.com/facebook-logo.svg" class="w-28 mx-auto brightness-0 invert" alt="facebook-logo" />
              <img src="https://readymadeui.com/linkedin-logo.svg" class="w-28 mx-auto brightness-0 invert" alt="linkedin-logo" />
              <img src="https://readymadeui.com/pinterest-logo.svg" class="w-28 mx-auto brightness-0 invert" alt="pinterest-logo" />
            </div>
          </div>
          <div class="absolute inset-0 w-full h-full bg-[url('https://readymadeui.com/bg-effect.svg')] opacity-20"></div>
        </div>

        <div class="px-4 sm:px-10">
          <div class="mt-32 max-w-7xl mx-auto">
            <div class="mb-16 max-w-2xl text-center mx-auto">
              <h2 class="md:text-4xl text-3xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-cyan-700">Our Features</h2>
              <p class="mt-6 text-gray-100">Experience powerful features designed to transform your workflow and enhance productivity.</p>
            </div>
            <div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8 text-black">
              <div class="sm:p-8 p-6 flex flex-col bg-white/10 backdrop-blur-lg rounded-2xl border border-white/10 hover:bg-white/20 transition-all">
                <div class="bg-gradient-to-br from-cyan-500 to-cyan-700 w-14 h-14 rounded-xl flex items-center justify-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-7 h-7 text-white" viewBox="0 0 32 32">
                ...
                <div class="text-white">
                  ...
                  <p class="text-gray-300">Tailor our product to suit your needs with powerful customization options and flexible configurations.</p>
              </div>
              </div>

              <div class="sm:p-8 p-6 flex flex-col bg-white/10 backdrop-blur-lg rounded-2xl border border-white/10 hover:bg-white/20 transition-all">
                <div class="bg-gradient-to-br from-cyan-500 to-cyan-700 w-14 h-14 rounded-xl flex items-center justify-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-7 h-7 text-white" viewBox="0 0 682.667 682.667">
                  <defs>
                ...
                <div class="text-white">
                  ...
                  <p class="text-gray-300">Your data is protected by enterprise-grade security measures and advanced encryption protocols.</p>
                </div>
              </div>

              <div class="sm:p-8 p-6 flex flex-col bg-white/10 backdrop-blur-lg rounded-2xl border border-white/10 hover:bg-white/20 transition-all">
                <div class="bg-gradient-to-br from-cyan-500 to-cyan-700 w-14 h-14 rounded-xl flex items-center justify-center mb-6">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-7 h-7 text-white" viewBox="0 0 512.001 512.001">
                    <path d="M271.029 0c-33.091 0-61 27.909-61 61s27.909 61 61 61 60-27.909 60-61-26.909-61-60-61zm66.592 122c-16.485 18.279-40.096 30-66.592 30-26.496 0-51.107-11.721-67.592-30-14.392 15.959-23.408 36.866-23.408 60v15c0 8.291 6.709 15 15 15h151c8.291 0 15-6.709 15-15v-15c0-23.134-9.016-44.041-23.408-60z" />
                  </svg>
                </div>
                <div class="text-white">
                  <h3 class="text-xl font-semibold mb-4">Support</h3>
                  <p class="text-gray-300">24/7 dedicated customer support to assist you with any questions or concerns you may have.</p>
                </div>
              </div>
            </div>
          </div>

          <div class="mt-32 bg-white rounded-md px-4 py-12 text-black">
          ...
          <div class="mt-32 text-white">
            ...
            <div class="grid md:grid-cols-3 md:py-16 gap-8 max-w-7xl max-md:max-w-lg mx-auto relative text-black">
              <div
          ...
          <div class="mt-32 max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mt-16 max-md:max-w-lg max-md:mx-auto text-black">
              ...
              <div class="bg-cyan-600 rounded sm:p-6 p-4 text-white shadow-lg shadow-cyan-300">
          ...
          <div class="mt-32">
            <div class="sm:max-w-7xl max-w-sm mx-auto">
              ...
              <div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-x-8 gap-y-20 text-center mt-32 text-black">
          ...
          <div class="bg-white mt-32 px-4 py-12">
            <div class="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-5xl text-black">
              <div>
          ...
          <div class="bg-blue-100 py-20 sm:px-6 px-4 rounded-md mt-32 text-black">
        ...
        <footer class="bg-white px-4 sm:px-10 py-12 mt-32 text-black">
