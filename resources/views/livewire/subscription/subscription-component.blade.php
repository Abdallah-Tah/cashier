    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            @foreach ($plans as $plan)
                <div
                    class="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-200 hover:scale-105">
                    <div class="p-8">
                        <div class="text-center">
                            ...
                            <div class="mb-6">
                                <span
                                    class="text-4xl font-bold text-blue-600">${{ number_format($plan->price, 2) }}</span>
        ...
        @if ($selectedPlan)
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden mt-8">
                <div class="p-8">
                    ...
                    <p class="text-gray-600 mb-8">You've selected the {{ $selectedPlan->name }} plan at
                        ${{ number_format($selectedPlan->price, 2) }}/{{ $selectedPlan->billing_interval }}</p>
                    ...
                    <form wire:submit.prevent="subscribe" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="driverLicense"
                                    class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200"
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2">Accident History (Last 3
                                Years)</label>
                            <textarea wire:model="accidentHistory" rows="3"
                                class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200"
                                placeholder="Please describe any accidents or claims in the last 3 years"></textarea>
                            @error('accidentHistory')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
